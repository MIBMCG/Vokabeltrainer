...
test('serves only named probe and trainer assets with correct MIME types', async () => {
  await withServer(async (port) => {
    const cases = [
      ['/shop-probe/', 'text/html; charset=utf-8'],
      ...
      ['/src/trainer/sync/packets.js', 'text/javascript; charset=utf-8'],
      ['/src/trainer/sync/drive.js', 'text/javascript; charset=utf-8'],
      ['/src/trainer/sync/scheduler.js', 'text/javascript; charset=utf-8'],
