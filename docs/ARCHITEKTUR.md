...
Die [Architekturvorlage A/B/C](design/2026-09-20-kaufkoordination-nach-diagnose6.md) ist eine offene Empfehlung. Eine Google-interne Apps-Script-Kaufzentrale ist noch nicht beschlossen oder eingerichtet; kein neuer Backenddienst wird aus dem nachfolgenden Architekturüberblick abgeleitet. Maßgeblich ist die [aktuelle Übergabe](handoffs/2026-09-20-shop-v6-auswertung-und-architekturwahl.md).
