...
| GPT-5.6 Sol / high für unabhängige B1/B2-Review | Der vorbereitete, verfügbare Sol-Reviewer ist unabhängig vom Astra-Implementierer; ein zusätzlicher Agent konnte nicht gestartet werden. | Abweichung vom Modellvorschlag für die Vertragsreview, keine ausgelassene Prüfaufgabe. |
