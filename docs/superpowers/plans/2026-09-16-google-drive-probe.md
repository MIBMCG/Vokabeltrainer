...
- [ ] Commit docs and verified implementation; push under the user's project handoff instruction only after review. Der lokale Task-2-Code ist bis `230defb` committed; die Task-3-Dokumentation ist Bestandteil des anschließenden lokalen Dokumentationscommits. Push, Remote-SHA-Vergleich und Integration nach `main` bleiben für die übergeordnete Abschlussprüfung offen.
