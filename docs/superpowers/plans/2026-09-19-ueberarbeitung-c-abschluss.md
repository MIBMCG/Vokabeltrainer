...
- [x] **4. Offline-/Bild-/Updatefälle prüfen.** Eine Größe online laden, danach Netz sperren und größere Ansichtsgröße wählen: hochauflösender Fehler fällt einmalig auf vorab gecachte Basis zurück. Testkern nach normalem Einrichten des Gerätefixtures:
