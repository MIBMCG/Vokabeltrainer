...
GitHub-Empfangsbeleg: Der geprüfte A1-Zwischenstand `b0e826c5b7e78d4aa5fa9727e317bf991c905a2c` wurde auf `codex/vokabeltrainer-v1` gepusht; `git ls-remote` bestätigte denselben vollständigen Hash. Keine Änderung von `main`, Hosting oder persönlichen Browserdaten.
...
- A3–A4 bleiben offen: vorbereitete öffentliche Google-ID und vier Hauptbereiche für Erwachsene mit Entwurfsschutz.
