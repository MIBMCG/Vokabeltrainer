...
- B3 ist mit `c04ffd9` und Fix `2f0a126` abgeschlossen und unabhängig freigegeben: Elternregler mit geschützten Entwürfen, Vorschau und Wiederüben. Cache v17 / synthetisch v18; nach Fix 4/4 B3-Browser, 1/1 Update, 15/15 Server/Worker. [Bericht](../reports/2026-09-19-b3-elternregler.md), [Review](../reports/2026-09-19-b3-review.md). C2 muss den dokumentierten einmaligen Fehler des Offline-Diagnosetests im breiten 11/12-Lauf klären; die isolierte Wiederholung war 1/1 grün.
- C1 ist in `9457ced` ohne Reviewbefunde abgeschlossen: Statistik aus gemeinsamen Fakten samt Wortdetails; 343/343 Node, 19/19 fokussierte und 6/6 betroffene Browserprüfungen, Cache v18 / synthetisch v19. [Bericht](../reports/2026-09-19-c1-statistik.md), [Review](../reports/2026-09-19-c1-review.md). C2: Gesamtprüfung, Offline-/Update-/Migrationsfälle, echte Bildmatrix und portable Übergabe.
