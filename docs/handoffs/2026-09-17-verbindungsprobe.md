...
1. Verfügbarkeit von iPhone/iPad beim Freund und eine passende HTTPS-Bereitstellung klären. Die [Google-Einrichtung](../GOOGLE-DRIVE-PROBE.md#google-einmalig-vorbereiten) für den lokalen Test ist erfolgt.
