...
**O-KO01 offen nach Diagnose 6:** Der [neue echte Bericht](reports/2026-09-20-shop-v6-reallauf.md) hat 6 bestandene und 5 fehlgeschlagene Fälle. Vier betreffen die Lesestabilität; der falsche Token hat einen mehrdeutigen Fehler, ein anderer Fall belegt eine 412-Ablehnung eines alten Tokens. Keine weitere unveränderte Probe. Die [Entscheidungsvorlage zur Kaufkoordination](design/2026-09-20-kaufkoordination-nach-diagnose6.md) empfiehlt A: Google-interne Kaufzentrale mit Apps Script zunächst ausarbeiten und prüfen. B würde ausgebbares Guthaben durch Gesamtpunkt-Freischaltungen ersetzen; C untersucht direkten Drive-Zugriff nur mit neuer Hypothese weiter. Noch keine Nutzerwahl, keine Backendfreigabe und keine Änderung von EV01–EV05. Bestehende Entwicklungs- und Dokumentationsaufträge bleiben im übrigen Umfang erhalten.
