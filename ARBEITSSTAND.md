...
**Aktuelle Entscheidung vom 20.09.2026:** Die künftige Avatar-Erweiterung wechselt von modularer Ausrüstung zu vier vollständig gerenderten Entwicklungsformen je Figur. Erspielte Punkte dienen der Avatarentwicklung; Level und Lernfortschritt bleiben erhalten. Freigeschaltete Formen bleiben dauerhaft auswählbar. Der erste [Drachen-Konzeptbogen](docs/design/avatar-evolution/dragon-stages-concept-v1.png) ist als vierteilige Gesamtvorschau erstellt und wartet auf persönliche Beurteilung. Freigestellte Produktionsgrafiken, konkrete Preise, Datenvertrag, Produktintegration und die weiteren Figuren bleiben im Detaildesign zu konkretisieren; die allgemeine Entwicklungsfreigabe besteht fort. [Entscheidung](docs/design/2026-09-20-avatar-entwicklungsstufen.md), [aktuelle Übergabe](docs/handoffs/2026-09-20-avatar-evolution-prototype.md).
...
Die Überarbeitung A1–C2 und die Bildkorrekturen v3 nicht erneut beginnen. Die [aktuelle Übergabe](docs/handoffs/2026-09-20-avatar-fit-v3-und-probe-v4.md) enthält die frischen Prüfbelege und Bilder. Nächster konkreter Schritt ist die Auswertung eines echten `shop-probe-bericht4.json` mit derselben v2-JSON-Auswahl; keine unveränderte Version-3-Probe wiederholen. Figuren-/Shop-Integration folgt erst dem nachgewiesenen sicheren Kaufvertrag. Die [Geräte-Prüfliste](docs/GERAETE-ABNAHME.md), echter Google-Abgleich auf zwei Geräten und persönliche visuelle Abnahme bleiben offen. HTTPS-Bereitstellung erfordert einen eigenen Auftrag. Bestätigte Produktentscheidungen nicht erneut abfragen.
