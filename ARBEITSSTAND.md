...
Die Umsetzung folgt dem [v1-Plan](docs/superpowers/plans/2026-09-17-vokabeltrainer-v1.md) und [Produkt-Datenvertrag](docs/PRODUKT-DATENFORMAT.md). Task 1 ist in `2e8b6a2` und `cf99ed7` umgesetzt und unabhängig geprüft: striktes Ereignisformat, sichere Referenzen, Kollisionsschutz und Testbasis. Ein Zeitüberlauf in Testdaten und eine Stapelgrenze bei langen Bearbeitungsketten wurden mit Regressionstests korrigiert. Aktueller belegter Lauf: **91/91 Node-Tests**, davon 17 Formatprüfungen. Die Lernoberfläche ist noch nicht implementiert. Task 2 ist in `5e991bf`/`4527736` implementiert und unabhängig freigegeben (Gesamtlauf inzwischen **108/108**); Details in der aktuellen Übergabe. Task 3 ist in `99920da`/`1bbd80b` implementiert und unabhängig geprüft: Antwortprüfung, Tagesabstände, Punkte, Belohnungsregeln und dauerhafte Lernmeilensteine. Der aktuelle Gesamtlauf umfasst **135/135 Tests**; die Nachprüfung der vier korrigierten Lern-/Abgleichfälle ist sauber. Task 4 ist in `49fbfb2` umgesetzt und unabhängig freigegeben: fortsetzbarer Rundenablauf mit drei Modi, adaptiver Auswahl, bewusster Erweiterung und Abschlussregeln. Aktueller Gesamtlauf: **149/149 Tests**. Task 5 ist in `43e956a` umgesetzt und unabhängig freigegeben: atomare Speicherung, serielle Befehle, Schutz vor veralteten Änderungen und gemeinsame Sicherung von Antwort/Runde/Meilensteinen. Aktueller Gesamtlauf **171/171**. Task 6 erstellt jetzt Einrichtung und Erwachsenenoberfläche; echte Browser-IDB- und Lifecycle-Prüfungen folgen dort. Zwischenstand `4c70a89f85176e5594e15faca6b2d886fddd53a3` ist mit identischem Remote-Nachweis auf `origin/codex/vokabeltrainer-v1` gesichert; die Entwicklung läuft weiter.
