...
**Gesicherter Ausgangspunkt:** `f870e53c8526e62d0a21c5f6710bcf8346414283` auf `codex/vokabeltrainer-v1`. Der Bildstand aus `026186c` bleibt erhalten, seine positive Passformbewertung wurde nach erneuter Nutzerkritik zurückgenommen. Der neue Arbeits-/Prüfstand steht in der [aktuellen Übergabe](docs/handoffs/2026-09-20-avatar-fit-und-drive-v2.md).

**Aktuell 20.09.2026:** Zweiter echter Google-Lauf ausgewertet; isolierte Diagnoseversion 3 mit neuem v2-JSON-Leseweg vorbereitet. Avatar-Passform erneut offen, darunter alle Huf-/Pfotenreifen sowie örtliche Verdeckungen bei Kragen, Händen und Flügeln. Keine visuelle Abnahme behaupten; Bildumfang bleibt vorerst 98 Lagen / 294 WebPs.
