...
**Code-Zwischenstand:** [codex/google-drive-probe](https://github.com/MIBMCG/Vokabeltrainer/tree/codex/google-drive-probe). Dieser main-Zweig enthält die aktuelle Dokumentation; zum Ausführen der Tests zuerst auf den Entwicklungszweig wechseln (Anleitung unten).
