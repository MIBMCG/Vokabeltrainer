...
**Neue Avatar-Erweiterung in Arbeit:** Die Hemdbilder der bestehenden Figur sind korrigiert; der Hals bleibt in allen Farben sichtbar. Entdeckerin, Tiere, mystische Figuren und passende Ausrüstung werden als responsive Rasterbilder vorbereitet und nach erneuter Kritik körperbezogen überarbeitet. [Bildkorrekturen und Vergleichsbilder](docs/reports/2026-09-20-avatar-fit-v3.md). Die neue Figurenwahl und der Punkteshop sind noch nicht in der App nutzbar. Die echte Kaufprobe liefert jetzt eine lesbare Versionskennung, besteht aber noch nicht vollständig; Diagnoseversion 4 grenzt die Fehler genauer ein. Prüfstand und Fortsetzung stehen in der [aktuellen Übergabe](docs/handoffs/2026-09-20-avatar-fit-v3-und-probe-v4.md). Der folgende Abschluss beschreibt die vorherige Überarbeitung A1–C2.
