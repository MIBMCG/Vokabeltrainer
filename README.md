...
**Avatar-Entwicklung, Stand 20. September 2026:** Die bestätigte Erweiterung ergänzt vier vollständige Entwicklungsformen je Figur und behält die bisherige Gestaltung als „Klassisch“. Der Stufenkatalog ist implementiert und geprüft; die ersten vier Drachenbilder sind als transparente Einzelillustrationen vorbereitet. [Bildvorschau und Nachweise](docs/reports/2026-09-20-avatar-evolution-foundation.md). Neue Figurenwahl und Punktekäufe sind noch nicht in der App aktiviert. Der echte Shop-Probelauf mit Diagnose 6 hat sechs bestandene und fünf fehlgeschlagene Szenarien; die sichere Kaufkoordination bleibt unbewiesen. Der Nutzer hat die weitere gezielte Direkt-Drive-Analyse gewählt. Diagnose 7 bietet dafür eine gezielte Prüfung der falschen Schreibkennung mit getrennten Schreib- und Nachleseergebnissen (84/84 Logiktests, 13/13 Browserfälle bestanden; unabhängige Review ohne offene relevante Befunde); kein Backendwechsel, keine Änderung des Punktesystems und keine unveränderte Vollprobe. Aktueller Stand, offene Bildproduktion und nächste Schritte stehen in der [Übergabe](docs/handoffs/2026-09-20-shop-v7-auswertung-und-leseprobe.md). Der folgende Abschluss beschreibt die vorherige Überarbeitung A1–C2.
