...
**Dauerhafte Käufe freigegeben (20.09.2026):** Der Nutzer hat den [Integrationsentwurf](docs/superpowers/specs/2026-09-20-persistent-purchases-design.md) mit „ja“ bestätigt. Die Umsetzung läuft nach dem [Implementierungsplan](docs/superpowers/plans/2026-09-20-persistent-purchases.md): dauerhafte Aufträge, Wiederaufnahme, gemeinsame Kauf-/Restoregrenze und gesicherte Datenaktualisierung. Keine erneute Startfreigabe nötig. Implementierung GPT-5.6 Sol/hoch, unabhängige Prüfung GPT-6 Astra/hoch. [Laufende Übergabe](docs/handoffs/2026-09-20-persistent-purchases-implementation.md). Die frühere Entwurfsübergabe ist Vorgeschichte; ein fertiger Produktshop ist damit noch nicht behauptet.
