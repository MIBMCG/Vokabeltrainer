...
**Fortsetzung ausdrücklich beauftragt (21.09.2026):** Die Pause ist beendet. Auf `codex/vokabeltrainer-v1` zuerst die vier wichtigen Reviewbefunde zum Kaufkern beheben und unabhängig nachprüfen, danach Aufgaben 2–6 des bestätigten Kaufplans ausführen. Aktueller Verlauf: [Fortsetzungsübergabe](docs/handoffs/2026-09-21-persistent-purchases-fortsetzung.md). Die [Pause vom 20.09.](docs/handoffs/2026-09-20-pause-persistent-purchases.md) bleibt historische Grundlage. Keine erneute Grundsatzfreigabe nötig; keine reale Geräteabnahme behaupten.
