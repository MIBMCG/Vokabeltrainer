...
**Neue Avatar-Erweiterung in Arbeit:** Die Hemdbilder der bestehenden Figur sind korrigiert; der Hals bleibt in allen Farben sichtbar. Entdeckerin, Tiere, mystische Figuren und passende Ausrüstung werden als responsive Rasterbilder vorbereitet. Die neue Figurenwahl und der Punkteshop sind noch nicht in der App nutzbar. Kaufprobe, aktueller Prüfstand und Fortsetzung stehen in der [Avatar-Shop-Übergabe](docs/handoffs/2026-09-19-avatar-shop.md). Der folgende Abschluss beschreibt die vorherige Überarbeitung A1–C2.
