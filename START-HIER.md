...
3. [Aktuelle Übergabe zur gewählten direkten Drive-Diagnose](docs/handoffs/2026-09-20-direkt-drive-c-und-gezielte-probe.md); [Bild-/Probe-v4-Übergabe](docs/handoffs/2026-09-20-avatar-fit-v3-und-probe-v4.md) und [A1–C2-Übergabe](docs/handoffs/2026-09-19-ueberarbeitung.md) als Vorgeschichte
...
> Arbeite am Repository MIBMCG/Vokabeltrainer auf `codex/vokabeltrainer-v1` weiter. Lies AGENTS.md, ARBEITSSTAND.md und docs/handoffs/2026-09-20-direkt-drive-c-und-gezielte-probe.md. Prüfe Branch, Remote und lokale Änderungen. EV01–EV05 und die Drachenbildrichtung sind bestätigt; Katalog und vier von 76 Bildquellen sind umgesetzt. Der echte Diagnose-6-Bericht ergibt 6 bestandene und 5 fehlgeschlagene Fälle. Vier betreffen instabile Reads; die falsche ETag hat einen mehrdeutigen Fehler, während ein anderer Fall eine 412-Ablehnung eines alten Tokens belegt. Keine sichere Parallelkoordination ableiten. O-KO01 ist mit C entschieden: gezielte Direkt-Drive-Untersuchung. Lies den Diagnose-7-Plan und die aktuellen Prüfbelege; A/B/C nicht nochmals abfragen. Keine weitere unveränderte Probe, keine gelockerten Schutzbedingungen und kein stiller Backendwechsel. Kein Produktshop ist aktiviert.
