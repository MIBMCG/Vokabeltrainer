...
**Neuer echter Befund (Diagnose 8):** 1 Check bestanden, 1 fehlgeschlagen. Zwei Metadatenabrufe vor dem Inhaltsdownload waren stabil; erst im Medienfenster stieg die Version bei gleichen verfügbaren Inhaltsmerkmalen. Das belegt das Zeitfenster, keine Ursache und keine Schreibbedingung. [Auswertung](docs/reports/2026-09-20-shop-v8-reallauf.md). Die gezielte Diagnose 9 prüft deshalb ausschließlich kleine Eigenschaften neuer synthetischer Ordner, ohne Inhaltsdownload. Die Umsetzung und unabhängige Review sind abgeschlossen: 127/127 Shop-Node-Tests und 20/20 Shop-Browserfälle bestanden. Der nächste echte Google-Lauf steht aus; siehe [aktuelle Übergabe](docs/handoffs/2026-09-20-shop-v8-auswertung-und-metadatenprobe.md). Keine unveränderte Probe erneut anfordern; C bleibt entschieden.

**Aktueller Stand (20.09.2026):** EV01–EV05 sind bestätigt: vollständige Stufenkäufe für 200 / 400 / 800 Punkte, je vier kostenlose menschliche Hauttöne, zusätzliche klassische Gestaltung und die Bereiche „Meine Figur“, „Entwicklung“, „Shop“. Der reine Stufenkatalog und die ersten vier freigestellten Drachenbilder sind in `650cee7` implementiert beziehungsweise erzeugt und unabhängig geprüft. 379/379 Produkttests bestanden; 4 von 76 Bildmotiven sind vorbereitet. Neue Stufenwahl und Käufe sind noch nicht im Produkt eingebunden. [Grundlagenbericht](docs/reports/2026-09-20-avatar-evolution-foundation.md), [aktuelle Übergabe](docs/handoffs/2026-09-20-shop-v8-auswertung-und-metadatenprobe.md).
...
3. [Aktuelle Übergabe zur gewählten direkten Drive-Diagnose](docs/handoffs/2026-09-20-shop-v8-auswertung-und-metadatenprobe.md); [Bild-/Probe-v4-Übergabe](docs/handoffs/2026-09-20-avatar-fit-v3-und-probe-v4.md) und [A1–C2-Übergabe](docs/handoffs/2026-09-19-ueberarbeitung.md) als Vorgeschichte
...
> Arbeite am Repository MIBMCG/Vokabeltrainer auf `codex/vokabeltrainer-v1` weiter. Lies AGENTS.md, ARBEITSSTAND.md und docs/handoffs/2026-09-20-shop-v8-auswertung-und-metadatenprobe.md. Prüfe Branch, Remote und lokale Änderungen. EV01–EV05 und Drachenbildrichtung sind bestätigt, vier von 76 Bildquellen vorbereitet. Bericht 8 ist vollständig ausgewertet: Kontrolllesen vor dem Inhalt stabil, Version erst im Medienfenster gestiegen; keine bewiesene Ursache. O-KO01 bleibt C: direkten Drive-Ansatz gezielt untersuchen. Diagnose 9 isoliert Ordner-Metadaten ohne Medienabruf. Lies Plan und tatsächliche Prüfbelege in der Übergabe. Keinen identischen 8er-Lauf erneut fordern, A/B/C nicht nochmals abfragen. Schutzbedingungen unverändert, kein stiller Backendwechsel, kein Produktshop aktiviert.
