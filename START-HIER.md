...
**EV01 bestätigt (Nutzerantwort a, 20.09.2026):** Ganze Entwicklungsstufe mit einem bewussten Kauf vollständig freischalten; keine Teilbeträge pro Avatar. Nächste offene Frage EV02: Preise für die drei Aufstiege. Siehe die laufenden Entscheidungen im Avatar-Entwicklungsstufen-Dokument.

**Aktuelle Richtung, bestätigt am 20.09.2026:** Vier vollständig gerenderte Entwicklungsformen je Avatar ersetzen für die künftige Erweiterung die modulare Ausrüstung. Bogen v1 wurde wegen eines zu kleinen Unterschieds zwischen Stufe 3 und 4 nicht abgenommen. Der Nutzer hat den [überarbeiteten Drachenbogen v2](docs/design/avatar-evolution/dragon-stages-concept-v2.png) mit „ja, viel besser“ bestätigt; seine deutlich epischere, mythische Endverwandlung ist die Stilvorlage und braucht keine erneute Bildfreigabe. Die Produktoberfläche bleibt vorerst unverändert. Freigestellte Produktionsgrafiken, Preise, weitere Bedienungsdetails, Datenmodell und die restlichen Figuren sind noch offen. Der echte Diagnose-4-Lauf ergab 3 bestandene und 8 fehlgeschlagene Fälle; der v2-ETag-/v3-Schreibkandidat belegt keinen exklusiven Kauf-Guard. [Entscheidung](docs/design/2026-09-20-avatar-entwicklungsstufen.md), [Auswertung](docs/reports/2026-09-20-shop-v4-reallauf.md), [aktuelle Übergabe](docs/handoffs/2026-09-20-avatar-evolution-prototype.md).
...
3. [Aktuelle Übergabe zu Avatar-Entwicklungsstufen](docs/handoffs/2026-09-20-avatar-evolution-prototype.md); [Bild-/Probe-v4-Übergabe](docs/handoffs/2026-09-20-avatar-fit-v3-und-probe-v4.md) und [A1–C2-Übergabe](docs/handoffs/2026-09-19-ueberarbeitung.md) als Vorgeschichte
...
> Arbeite am Repository MIBMCG/Vokabeltrainer auf `codex/vokabeltrainer-v1` weiter. Lies zuerst AGENTS.md, ARBEITSSTAND.md und docs/handoffs/2026-09-20-avatar-evolution-prototype.md. Prüfe Branch, Remote und lokale Änderungen. Die künftige Avatar-Erweiterung verwendet vier vollständig gerenderte Entwicklungsformen statt modularer Ausrüstung. Bogen v1 wurde wegen eines zu kleinen Unterschieds zwischen Stufe 3 und 4 nicht abgenommen. Bogen v2 mit epischer, mythischer Endverwandlung ist persönlich bestätigt und nicht erneut freizugeben. Kläre als Nächstes die Details der Punkteinvestition einzeln; freigestellte Produktionsgrafiken, konkrete Preise, Datenmodell, Produktintegration und alle weiteren Figuren bleiben im Detaildesign zu konkretisieren. Die allgemeine Entwicklungsfreigabe besteht fort. Der echte Diagnose-4-Lauf hat 3 Fälle bestanden und 8 Fehler; bei Initialisierung und zwei Käufen wurden jeweils beide parallelen Schreibversuche angenommen. Keine weitere unveränderte Probe anfordern und keine Guards lockern. Die Produktoberfläche, echte Geräteabnahme und Hosting bleiben getrennt. Keine privaten Browserdaten verwenden oder löschen.
