...
**Dauerhafte Käufe konkret entworfen (20.09.2026):** Der [Integrationsentwurf](docs/superpowers/specs/2026-09-20-persistent-purchases-design.md) liegt zur Abstimmung vor: dauerhafte Aufträge, Wiederaufnahme nach Neustart, gemeinsame Kauf-/Restoregrenze und gesicherte Datenaktualisierung. Noch keine Umsetzung dieses Pakets und noch keine Zustimmung zum neuen Detailentwurf. Allgemeine Entwicklungsfreigabe, C und EV01–EV05 bleiben erhalten. [Aktuelle Übergabe](docs/handoffs/2026-09-20-persistent-purchases-design.md). Nach Zustimmung folgt der detaillierte Implementierungsplan; keine zusätzliche allgemeine Startgenehmigung verlangen.
