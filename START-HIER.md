...
**Aktive Umsetzung, aktualisiert 20.09.2026:** Klassische Bildbearbeitung ist ausdrücklich freigegeben. Die körperbezogene Nacharbeit aller 13 Figuren / 62 kompatiblen Artikelpaare ist im [Bildbericht v3](docs/reports/2026-09-20-avatar-fit-v3.md) dokumentiert; frühere pauschale Passformurteile bleiben zurückgenommen. Der neue echte v2-JSON-Bericht belegt eine lesbare Versionskennung, aber keine sichere Kaufkoordination (5 bestanden, 6 fehlgeschlagen). Die isolierte Diagnoseversion 4 ergänzt konkrete Fehlerstellen und Antwortklassen, ohne Schreibwege oder Sperren zu ändern. [Google-Auswertung](docs/reports/2026-09-20-shop-v2-reallauf.md). Neue Figurenwahl und Käufe sind weiterhin nicht im Produkt aktiviert. [Aktuelle Übergabe](docs/handoffs/2026-09-20-avatar-fit-v3-und-probe-v4.md).

**Aktuell in Umsetzung:** [Avatar-Erweiterung und Punkteshop](docs/design/2026-09-19-avatar-shop-entscheidungen.md), AV01–AV12 bestätigt, Offlinekauf ausgeschlossen. Der [Gesamtentwurf](docs/superpowers/specs/2026-09-19-avatar-shop-design.md) ist freigegeben; keine bereits bestätigten Einzelentscheidungen wiederholen. Produktshop noch nicht integriert. Die Google-Kaufprobe unter `/shop-probe/` läuft inzwischen; der erste Medienlauf ist ausgewertet. Der echte v2-JSON-Lauf ist ausgewertet; nächster technischer Nachweis ist die konkretisierte Diagnoseversion 4.
...
Maßgeblich sind der [aktuelle Bildbericht](docs/reports/2026-09-20-avatar-fit-v3.md), der [Arbeitsstand](ARBEITSSTAND.md) und die [aktuelle Übergabe](docs/handoffs/2026-09-20-avatar-fit-v3-und-probe-v4.md). Der [v1-Abschluss vom 18.09.2026](docs/reports/2026-09-18-vokabeltrainer-v1.md) und die [Überarbeitung A1–C2](docs/reports/2026-09-19-ueberarbeitung.md) bleiben historische Grundlagen; ihre Tests und Screenshots nicht als Nachweis für spätere Änderungen ausgeben.
...
3. [Aktuelle Avatar-Shop-Übergabe](docs/handoffs/2026-09-20-avatar-fit-v3-und-probe-v4.md); [A1–C2-Übergabe](docs/handoffs/2026-09-19-ueberarbeitung.md) als Vorgeschichte
...
> Arbeite am Repository MIBMCG/Vokabeltrainer auf `codex/vokabeltrainer-v1` weiter. Lies zuerst AGENTS.md, ARBEITSSTAND.md und docs/handoffs/2026-09-20-avatar-fit-v3-und-probe-v4.md. Prüfe Branch, Remote und lokale Änderungen. A1–C2 sind abgeschlossen. Die Avatar-Erweiterung AV01–AV12 ist bestätigt; klassische Bildbearbeitung ausdrücklich erlaubt. Bildkorrekturen v3 für 13 Figuren/62 Paare sind gebaut und intern unabhängig geprüft, persönliche Abnahme bleibt offen. Keine erneute pauschale Methodenfreigabe verlangen. Der echte Drive-v2-JSON-Lauf hat 5 Fälle bestanden und 6 Fehler; Diagnoseversion 4 benennt jetzt konkrete Fehlerstellen. Nächster Schritt: einen neuen echten Bericht4 mit derselben v2-JSON-Auswahl auswerten. Neue Figurenwahl/Käufe bleiben bis zum sicheren Vertrag nicht im Produkt aktiviert. Keine Guards zum Bestehen der Probe lockern. Echte Geräteabnahme und Hosting bleiben getrennt. Keine privaten Browserdaten verwenden oder löschen.
