...
**Aktueller Stand (20.09.2026):** EV01–EV05 sind bestätigt: vollständige Stufenkäufe für 200 / 400 / 800 Punkte, je vier kostenlose menschliche Hauttöne, zusätzliche klassische Gestaltung und die Bereiche „Meine Figur“, „Entwicklung“, „Shop“. Der reine Stufenkatalog und die ersten vier freigestellten Drachenbilder sind in `650cee7` implementiert beziehungsweise erzeugt und unabhängig geprüft. 379/379 Produkttests bestanden; 4 von 76 Bildmotiven sind vorbereitet. Neue Stufenwahl und Käufe sind noch nicht im Produkt eingebunden. [Grundlagenbericht](docs/reports/2026-09-20-avatar-evolution-foundation.md), [aktuelle Übergabe](docs/handoffs/2026-09-20-shop-v5-auswertung-und-diagnose-v6.md).

**Echter Diagnose-5-Lauf ausgewertet:** 4 bestanden, 7 fehlgeschlagen. Alle sieben Abbrüche entstehen bei instabilen Lesevorgängen: File-Version verändert, starke ETag unverändert. Das ist kein Beleg zweier akzeptierter Konkurrenzschreibvorgänge. Sichere Käufe bleiben unbewiesen. [Auswertung](docs/reports/2026-09-20-shop-v5-reallauf.md). Diagnose 6 ist als reine Messverbesserung implementiert: 69/69 Shop-Node- und 10/10 Shop-Browserprüfungen bestanden; keine geänderten Schreibwege oder aufgeweichten Schutzprüfungen. Ein neuer echter Bericht muss Diagnoseversion 6 verwenden. [Begrenzter Plan](docs/superpowers/plans/2026-09-20-shop-probe-v6-diagnostics.md).
...
3. [Aktuelle Übergabe zur v5-Auswertung und Diagnose 6](docs/handoffs/2026-09-20-shop-v5-auswertung-und-diagnose-v6.md); [Bild-/Probe-v4-Übergabe](docs/handoffs/2026-09-20-avatar-fit-v3-und-probe-v4.md) und [A1–C2-Übergabe](docs/handoffs/2026-09-19-ueberarbeitung.md) als Vorgeschichte
...
> Arbeite am Repository MIBMCG/Vokabeltrainer auf `codex/vokabeltrainer-v1` weiter. Lies AGENTS.md, ARBEITSSTAND.md und docs/handoffs/2026-09-20-shop-v5-auswertung-und-diagnose-v6.md. Prüfe Branch, Remote und lokale Änderungen. EV01–EV05 und die Drachenbildrichtung sind bestätigt; Katalog und vier von 76 Bildquellen sind umgesetzt. Der echte v5-Bericht hat 4 bestandene und 7 an Lesestabilität gescheiterte Fälle. Das belegt keine akzeptierten Parallelkäufe und keine sichere Kaufkoordination. Setze am dokumentierten Stand von Diagnose 6 an; sie ergänzt nur Vergleichszustände und Lesekontexte. Schutzbedingungen nicht lockern, keine unbelegten Retry-/Wartefixes oder unveränderten Wiederholungsläufe. Kein Produktshop ist aktiviert.
