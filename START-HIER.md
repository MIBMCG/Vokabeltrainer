...
**Pause auf Nutzerwunsch (20.09.2026):** Der Entwurf für dauerhafte Käufe ist bestätigt. Aufgabe 1 liegt als unintegrierter Kaufkern in `7ec80fd` vor, hat aber vier wichtige offene Reviewbefunde und ist noch nicht freigegeben. Aufgaben 2–6 wurden nicht begonnen beziehungsweise nicht abgeschlossen. [Aktuelle systemunabhängige Übergabe](docs/handoffs/2026-09-20-pause-persistent-purchases.md), [Prüf- und Pausenbericht](docs/reports/2026-09-20-persistent-purchases-pause.md). Nach dem Sicherungspush nicht weiterarbeiten; erst bei ausdrücklicher Fortsetzung die Reviewbefunde beheben. Der neue Kaufkern bleibt von bestehender App und Probe getrennt. Keine erneute Grundsatzfreigabe nötig.
