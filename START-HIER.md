...
**Fortsetzung ausdrücklich beauftragt (21.09.2026):** Die Pause ist beendet. Auf `codex/vokabeltrainer-v1` sind die vier wichtigen Task-1-Befunde in `5904dec` korrigiert und unabhängig nachgeprüft. Task 2 (Transport/Einrichtung) ist einschließlich zweier Korrekturrunden bis `cd6ba45` unabhängig geprüft. Task 3 (dauerhafter Kaufservice und lokale Migration) läuft; danach Aufgaben 4–6 des bestätigten Kaufplans ausführen. Aktueller Verlauf: [Fortsetzungsübergabe](docs/handoffs/2026-09-21-persistent-purchases-fortsetzung.md). Die [Pause vom 20.09.](docs/handoffs/2026-09-20-pause-persistent-purchases.md) bleibt historische Grundlage. Keine erneute Grundsatzfreigabe nötig; keine reale Geräteabnahme behaupten.
