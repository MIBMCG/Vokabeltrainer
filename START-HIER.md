...
3. [Aktuelle Übergabe zur gewählten direkten Drive-Diagnose](docs/handoffs/2026-09-20-shop-v7-auswertung-und-leseprobe.md); [Bild-/Probe-v4-Übergabe](docs/handoffs/2026-09-20-avatar-fit-v3-und-probe-v4.md) und [A1–C2-Übergabe](docs/handoffs/2026-09-19-ueberarbeitung.md) als Vorgeschichte
...
> Arbeite am Repository MIBMCG/Vokabeltrainer auf `codex/vokabeltrainer-v1` weiter. Lies AGENTS.md, ARBEITSSTAND.md und docs/handoffs/2026-09-20-shop-v7-auswertung-und-leseprobe.md. Prüfe Branch, Remote und lokale Änderungen. EV01–EV05 und die Drachenbildrichtung sind bestätigt; Katalog und vier von 76 Bildquellen sind umgesetzt. Der echte Diagnose-7-Bericht ergibt 1 bestandenen und 1 fehlgeschlagenen Check; er bricht bei create-verification vor dem Negativ-PUT ab. Die Versionsnummer ändert sich, während ETag und verfügbare Inhaltsmerkmale gleich bleiben. Diagnose 8 untersucht mit Metadatenkontrolle vor Medienabruf dieses frühere Hindernis; den Stand der Umsetzung und Review in der Übergabe nachlesen. Keine sichere Parallelkoordination ableiten. O-KO01 ist mit C entschieden: gezielte Direkt-Drive-Untersuchung. Lies den Diagnose-8-Plan und die aktuellen Prüfbelege; A/B/C nicht nochmals abfragen. Keine weitere unveränderte Probe, keine gelockerten Schutzbedingungen und kein stiller Backendwechsel. Kein Produktshop ist aktiviert.
